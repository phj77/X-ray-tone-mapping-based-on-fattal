...
class Parameters:
    def __init__(self):
        self.gamma_values = [0.2, 0.4, 0.6, 0.8] # in paper: sect. 3.1
        self.delta = 0.005 # in paper: sect. 3.1
        self.eps = 1e-8
        ...
        self.max_iterations = 8 # maximum number of iterations for gradient descent